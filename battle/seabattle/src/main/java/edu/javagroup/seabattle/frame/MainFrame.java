...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void repaintMinePanel(StackTraceElement[] stackTraceElements) {
        if (Boolean.FALSE.equals(ImReadySingleton.instance(null).getImReady())) {
            String methodName = "";
    ...
    private void repaintEnemyPanel(StackTraceElement[] stackTraceElements) {
        if (EnemyReadySingleton.instance(null).getEnemyReady()) {
            if (MyStepSingleton.instance(null).getMyStep()) {
                String methodName = "";
                for (StackTraceElement stackTraceElement : stackTraceElements) {
